...
snrdB=7.4:0.1:8.1;
%snrdB=18.5:0.1:19.6;
FrameErrStop=1e2;          % Number of frame errors at which MC simulation stops

%Encoder/Decoder Parameters
Nblocks_min=FrameErrStop;
Nblocks_max=2e6;
...
switch DecoderType
    ...
    case 'SABM'
    filename=['iBDD-SABM_PAM' num2str(M) '_PC_BCH_n=' num2str(BCHn) '_t=' num2str(BCHt) '_e=' num2str(BCHe) '_NoIt=' num2str(I) '_R=' num2str(R) '_SABM_NoIt=' num2str(ItThresh) '.mat'] ;
    save([s_path filename],'snrdB','BERout_unc','SERout_unc','BERout','BERunc','SERunc','BER','r','R');
    case 'SABM-SR'
    filename=['iBDD-SABM-SR_PAM' num2str(M) '_PC_BCH_n=' num2str(BCHn) '_t=' num2str(BCHt) '_e=' num2str(BCHe) '_NoIt=' num2str(I) '_R='  num2str(R) '_SABM_NoIt=' num2str(ItThresh) '.mat'] ;
    save([s_path filename],'snrdB','BERout_unc','SERout_unc','BERout','BERunc','SERunc','BER','r','R','w');
    case 'SABM-SR-ST'
    filename=['iBDD-SABM-SR-ST_PAM' num2str(M) '_PC_BCH_n=' num2str(BCHn) '_t=' num2str(BCHt) '_e=' num2str(BCHe) '_NoIt=' num2str(I) '_R='  num2str(R) '_SABM_NoIt=' num2str(ItThresh) '.mat'] ;
    save([s_path filename],'snrdB','BERout_unc','SERout_unc','BERout','BERunc','SERunc','BER','r','R','w');
end
