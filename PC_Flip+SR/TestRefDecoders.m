...
%[~,BER(ss)]=Produ_IMP_cod_BCH_AWGN_chase_pyndiah_matlab_v2(It,EbNo(ss),BCHnu,BCHt,BCHs,modord,nblock);
BER(ss)=Produ_IMP_cod_BCH_AWGN_chase_pyndiah_matlab_v2(It,EbNo(ss),BCHnu,BCHt,BCHs,modord,FrameErrStop);
